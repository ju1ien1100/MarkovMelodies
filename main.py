...
b.f_ = [freq['Ab'][4],freq['Bb'][4],freq['C'][4],freq['Eb'][4],freq['F'][4],freq['G'][4],freq['F'][4],
        freq['Eb'][4],freq['C'][4],freq['Bb'][4],freq['Ab'][4],freq['Bb'][4],freq['C'][4],
        freq['Eb'][4],freq['F'][4],freq['G'][4],freq['F'][4],freq['Eb'][4],freq['C'][4],freq['F'][4],
        freq['Bb'][4],freq['C'][4],freq['Eb'][4],freq['F'][4],freq['G'][4],freq['F'][4],freq['Eb'][4]]  # the notes
